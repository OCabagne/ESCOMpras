...
<body>
	<escompras:container>
			<h2 class="fw-bold text-center py-3">Términos y Condiciones</h2>
			<p class="text-justify">
				Welcome to ESCOMpras!<br>
				<br>
				These terms and conditions outline the rules and regulations for the use of ESCOMpras's Website, located at http://tt1-escompras.herokuapp.com/.<br>
				<br>
				By accessing this website we assume you accept these terms and conditions. Do not continue to use ESCOMpras if you do not agree to take all of the terms and conditions stated on this page.<br>
				<br>
				...
				<br>
				Cookies<br>
				We employ the use of cookies. By accessing ESCOMpras, you agreed to use cookies in agreement with the ESCOMpras's Privacy Policy.<br>
				<br>
				...
				<br>
				License<br>
				Unless otherwise stated, ESCOMpras and/or its licensors own the intellectual property rights for all material on ESCOMpras. All intellectual property rights are reserved. You may access this from ESCOMpras for your own personal use subjected to restrictions set in these terms and conditions.<br>
				<br>
				You must not:<br>
				<br>
				Republish material from ESCOMpras<br>
				Sell, rent or sub-license material from ESCOMpras<br>
				Reproduce, duplicate or copy material from ESCOMpras<br>
				Redistribute content from ESCOMpras<br>
				...
				<br>
				Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. ESCOMpras does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of ESCOMpras,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, ESCOMpras shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.<br>
				<br>
				ESCOMpras reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.<br>
				<br>
				...
				You hereby grant ESCOMpras a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.<br>
				<br>
				...
				We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of ESCOMpras; and (d) the link is in the context of general resource information.<br>
				<br>
				...
				<br>
				If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to ESCOMpras. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.<br>
				<br>
				...
				No use of ESCOMpras's logo or other artwork will be allowed for linking absent a trademark license agreement.<br>
				<br>
				iFrames<br>
